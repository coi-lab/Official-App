  ...
  socket.on('onlineStack',function(stack){
    ...
    for (var user in stack){
      ...
      if(stack[user] == "Online"){
        var txt2 = $('<span class="badge"></span>').text(".").css({"float":"right","color":"#009933","font-size":"18px","background-color":"#009933"});
        totalOnline++;

      }
      else{
        var txt2 = $('<span class="badge"></span>').text(".").css({"float":"right","color":"#a6a6a6","font-size":"18px","background-color":"#a6a6a6"});
      }
      //listing all users.
